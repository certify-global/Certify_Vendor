...
class AppointmentListAdapter(var context: Context?, var appointmentList : ArrayList<AppointmentData>) : RecyclerView.Adapter<AppointmentListAdapter.AppointmentViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AppointmentViewHolder, position: Int) {
        holder.appointmentDate.text = Utils.getDate(appointmentList.get(position).start, "dd MMM yyyy")
